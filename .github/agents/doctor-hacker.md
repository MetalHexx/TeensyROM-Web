...
1. **Phase Execution**: Implement tasks from [PHASE_TEMPLATE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/PHASE_TEMPLATE.md) plans quickly and effectively
...
6. **Technical Debt Tracking**: Meticulously update [TECHNICAL_DEBT.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/features/TECHNICAL_DEBT.md) for all non-ideal solutions
...
1. **Immediately** add to [TECHNICAL_DEBT.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/features/TECHNICAL_DEBT.md) when using a hack
...
- [CODING_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/CODING_STANDARDS.md) - Review if doing proper implementation
- [STYLE_GUIDE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STYLE_GUIDE.md) - Check for existing utilities before creating new ones
- [COMPONENT_LIBRARY.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/COMPONENT_LIBRARY.md) - Reuse existing components
...
- [COMPONENT_LIBRARY.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/COMPONENT_LIBRARY.md) - Reusable UI components (update with hacks noted)
- [STYLE_GUIDE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STYLE_GUIDE.md) - Global styles and utilities (update with workarounds noted)
...
- [TECHNICAL_DEBT.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/features/TECHNICAL_DEBT.md) - Known debt items (**UPDATE AGGRESSIVELY**)
