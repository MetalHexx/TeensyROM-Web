...
5. **Documentation Phase**
   - Create [PLANNING_TEMPLATE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/PLANNING_TEMPLATE.md) capturing feature design and architecture
...
- See [E2E_TESTS.md](https://github.com/MetalHexx/TeensyROM-Web/tree/main/src/apps/teensyrom-ui-e2e/E2E_TESTS.md) for architecture, patterns, and implementation details
