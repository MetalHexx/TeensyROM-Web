...
**When asked to plan test additions or improvements**, you can create structured task plans using [PHASE_TEMPLATE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/PHASE_TEMPLATE.md):
...
- Reference specific test patterns from [TESTING_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/TESTING_STANDARDS.md)
...
- **[TESTING_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/TESTING_STANDARDS.md)** - Layer-specific testing strategies
- **[STORE_TESTING.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STORE_TESTING.md)** - Store behavioral testing patterns
- **[SMART_COMPONENT_TESTING.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/SMART_COMPONENT_TESTING.md)** - Feature component testing
...
- Read [OVERVIEW_CONTEXT.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/OVERVIEW_CONTEXT.md) to understand layer definitions
- Review [TESTING_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/TESTING_STANDARDS.md) for framework, testing philosophy, and layer-specific patterns
- Check [STORE_TESTING.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STORE_TESTING.md) for store behavioral testing details
- See [SMART_COMPONENT_TESTING.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/SMART_COMPONENT_TESTING.md) for feature component testing
- Reference [CODING_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/CODING_STANDARDS.md) for code style and conventions
...
**Detailed Guide**: See [E2E_TESTS.md](https://github.com/MetalHexx/TeensyROM-Web/tree/main/src/apps/teensyrom-ui-e2e/E2E_TESTS.md) for complete architecture, fixtures, interceptors, debugging strategies, and best practices.
...
This ensures responses are easy to parse and your recommendation guides the user toward the most evidence-based and systematic problem-solving approach.
...
- **[PHASE_TEMPLATE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/PHASE_TEMPLATE.md)** - Template for planning test additions with structured tasks

### Testing & Quality Documents

- **[TESTING_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/TESTING_STANDARDS.md)** - Testing approaches, behavioral testing patterns, and guidelines
- **[STORE_TESTING.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STORE_TESTING.md)** - Specialized testing patterns for store state and reducers
- **[SMART_COMPONENT_TESTING.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/SMART_COMPONENT_TESTING.md)** - Testing patterns for smart components
...
- **[CODING_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/CODING_STANDARDS.md)** - General coding patterns, naming conventions, and best practices

### Architecture & Design Documents

- **[OVERVIEW_CONTEXT.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/OVERVIEW_CONTEXT.md)** - Complete architecture guide with layer definitions and design patterns
- **[STATE_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STATE_STANDARDS.md)** - NgRx Signal Store patterns and state management best practices
- **[SERVICE_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/SERVICE_STANDARDS.md)** - Service layer patterns and conventions
- **[LOGGING_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/LOGGING_STANDARDS.md)** - Logging patterns and best practices

### Implementation & Reference

- **[API_CLIENT_GENERATION.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/API_CLIENT_GENERATION.md)** - How to regenerate API client when backend changes
- **[COMPONENT_LIBRARY.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/COMPONENT_LIBRARY.md)** - Reusable UI component catalog and patterns
- **[STYLE_GUIDE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STYLE_GUIDE.md)** - Global styles, utility classes, and theming
- **[NX_LIBRARY_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/NX_LIBRARY_STANDARDS.md)** - Library organization and module boundaries
- **[DEPENDENCY_CONSTRAINTS_PLAN.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/DEPENDENCY_CONSTRAINTS_PLAN.md)** - Clean Architecture layer constraints
