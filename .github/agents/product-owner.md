...
- Create/update PRD documents using **[PRD_TEMPLATE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/PRD_TEMPLATE.md)**
...
Essential sections from **[PRD_TEMPLATE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/PRD_TEMPLATE.md)**:
...
- **[PRD_TEMPLATE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/PRD_TEMPLATE.md)** - Template for product requirements (use this!)
- **[PLAYER_DOMAIN.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/features/player-state/PLAYER_DOMAIN.md)** - Example PRD
- **[OVERVIEW_CONTEXT.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/OVERVIEW_CONTEXT.md)** - System context (understand but don't discuss implementation)
- **[TODO.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/TODO.md)** - Product roadmap and backlog
