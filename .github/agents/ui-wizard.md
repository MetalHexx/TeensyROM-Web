...
1. **Phase Execution**: Implement tasks from [PHASE_TEMPLATE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/PHASE_TEMPLATE.md) plans created by Senior Engineer
...
4. **Documentation Maintenance**: Keep [COMPONENT_LIBRARY.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/COMPONENT_LIBRARY.md) and [STYLE_GUIDE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STYLE_GUIDE.md) current
5. **Pragmatic Debt Management**: Track technical debt in [TECHNICAL_DEBT.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/features/TECHNICAL_DEBT.md) when immediate fixes are impractical
...
1. Document in [TECHNICAL_DEBT.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/features/TECHNICAL_DEBT.md) with proper formatting
2. Note if it blocks current work or can be deferred
3. Suggest adding a future task to phase plan if appropriate

### Documentation Maintenance

**Component Library Updates** ([COMPONENT_LIBRARY.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/COMPONENT_LIBRARY.md)):
...
**Style Guide Updates** ([STYLE_GUIDE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STYLE_GUIDE.md)):
...
- Follow [TESTING_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/TESTING_STANDARDS.md) for all test approaches
- Use [STORE_TESTING.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STORE_TESTING.md) for store/state testing
- Reference [SMART_COMPONENT_TESTING.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/SMART_COMPONENT_TESTING.md) for component testing
...
- [CODING_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/CODING_STANDARDS.md) - Component structure, naming, TypeScript conventions
- [STATE_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STATE_STANDARDS.md) - If modifying stores or state
- [STYLE_GUIDE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STYLE_GUIDE.md) - If adding components or styles
- [COMPONENT_LIBRARY.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/COMPONENT_LIBRARY.md) - Reuse existing components before creating new ones
...
- Check [COMPONENT_LIBRARY.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/COMPONENT_LIBRARY.md) for existing reusable components
- Review [STYLE_GUIDE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STYLE_GUIDE.md) for utility classes and mixins
- Read relevant testing standards for the layer you're working in

**During implementation**:

- Reference [CODING_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/CODING_STANDARDS.md) for patterns
- Consult [STATE_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STATE_STANDARDS.md) for store patterns
- Review similar implementations via search/usages tools

**After implementation**:

- Update [COMPONENT_LIBRARY.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/COMPONENT_LIBRARY.md) if you created shared components
- Update [STYLE_GUIDE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STYLE_GUIDE.md) if you added global styles
- Add items to [TECHNICAL_DEBT.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/features/TECHNICAL_DEBT.md) if appropriate
...
- [OVERVIEW_CONTEXT.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/OVERVIEW_CONTEXT.md) - Architecture, layers, design patterns
- [PHASE_TEMPLATE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/PHASE_TEMPLATE.md) - Phase implementation plan structure

### Standards & Guidelines

- [CODING_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/CODING_STANDARDS.md) - Component patterns, naming, TypeScript conventions
- [TESTING_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/TESTING_STANDARDS.md) - Testing approaches by layer
...
- [STORE_TESTING.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STORE_TESTING.md) - Store testing patterns
- [SMART_COMPONENT_TESTING.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/SMART_COMPONENT_TESTING.md) - Component testing patterns
- [E2E_TESTS.md](https://github.com/MetalHexx/TeensyROM-Web/tree/main/src/apps/teensyrom-ui-e2e/E2E_TESTS.md) - E2E test architecture and patterns

### Implementation Guides

- [API_CLIENT_GENERATION.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/API_CLIENT_GENERATION.md) - API client regeneration
- [COMPONENT_LIBRARY.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/COMPONENT_LIBRARY.md) - Reusable UI components (keep updated)
- [STYLE_GUIDE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/STYLE_GUIDE.md) - Global styles and utilities (keep updated)
- [SERVICE_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/SERVICE_STANDARDS.md) - Service layer patterns
- [LOGGING_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/LOGGING_STANDARDS.md) - Logging patterns

### Reference

- [TECHNICAL_DEBT.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/features/TECHNICAL_DEBT.md) - Known debt items (add as needed)
- [NX_LIBRARY_STANDARDS.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/NX_LIBRARY_STANDARDS.md) - Library organization
- [DEPENDENCY_CONSTRAINTS_PLAN.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/DEPENDENCY_CONSTRAINTS_PLAN.md) - Layer constraints
