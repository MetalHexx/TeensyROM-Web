...
[Edit](https://vscode.dev/github/microsoft/vscode-docs/blob/main/docs/copilot/customization/custom-chat-modes.md "Edit this document in vscode.dev")
...
[What are custom chat modes?](https://code.visualstudio.com/docs/copilot/customization/custom-chat-modes#_what-are-custom-chat-modes)
-------------------------------------------------------------------------------------------------------------------------------------

The [built-in chat modes](https://code.visualstudio.com/docs/copilot/chat/copilot-chat#_switch-between-chat-modes) provide general-purpose configurations for chat in VS Code. For a more tailored chat experience, you can create your own chat modes.
...
[Why use custom chat modes](https://code.visualstudio.com/docs/copilot/customization/custom-chat-modes#_why-use-custom-chat-modes)
----------------------------------------------------------------------------------------------------------------------------------
...
[Handoffs](https://code.visualstudio.com/docs/copilot/customization/custom-chat-modes#_handoffs)
------------------------------------------------------------------------------------------------
...
### [Header (optional)](https://code.visualstudio.com/docs/copilot/customization/custom-chat-modes#_header-optional)
...
| `tools` | A list of tool or tool set names that are available for this chat mode. Can include built-in tools, tool sets, MCP tools, or tools contributed by extensions. Learn more about [tools in chat](https://code.visualstudio.com/docs/copilot/chat/chat-tools). |
...
### [Body](https://code.visualstudio.com/docs/copilot/customization/custom-chat-modes#_body)
...
### [Chat mode example](https://code.visualstudio.com/docs/copilot/customization/custom-chat-modes#_chat-mode-example)
...
[Create a chat mode](https://code.visualstudio.com/docs/copilot/customization/custom-chat-modes#_create-a-chat-mode)
--------------------------------------------------------------------------------------------------------------------
...
![Image 8: Screenshot showing the Chat view, and Configure Chat menu, highlighting the Configure Chat button.](https://code.visualstudio.com/assets/docs/copilot/customization/configure-chat-instructions.png)

Alternatively, use the **Chat: New Mode File** command in the Command Palette (⇧⌘P).

2.   Choose the location where the chat mode file should be created.

    *   **Workspace**: By default, workspace chat mode files are stored in the `.github/chatmodes` folder of your workspace. Add more prompt folders for your workspace with the [chat.modeFilesLocations](vscode://settings/chat.modeFilesLocations) setting.

    *   **User profile**: User chat mode files are stored in the [current profile folder](https://code.visualstudio.com/docs/configure/profiles). You can sync your user chat mode files across multiple devices by using [Settings Sync](https://code.visualstudio.com/docs/configure/settings-sync).
...
To edit and manage existing chat modes, in the Chat view, select **Configure Chat**>**Modes**, and then select select an existing chat mode from the list to modify it. Alternatively, you can use the **Chat: Configure Chat Modes** command from the Command Palette (⇧⌘P).

[Tool list priority](https://code.visualstudio.com/docs/copilot/customization/custom-chat-modes#_tool-list-priority)
--------------------------------------------------------------------------------------------------------------------
...
[Related resources](https://code.visualstudio.com/docs/copilot/customization/custom-chat-modes#_related-resources)
------------------------------------------------------------------------------------------------------------------
