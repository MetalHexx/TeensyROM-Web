# Phase 1: Basic Settings Endpoints
...
- [ ] [LaunchRandomEndpoint.cs](C:\dev\src\TeensyROM-Web\src\apps\api\src\TeensyRom.Api\Endpoints\Player\LaunchRandom\LaunchRandomEndpoint.cs) - Example endpoint with validation
- [ ] [SettingsService.cs](C:\dev\src\TeensyROM-Web\src\apps\api\src\TeensyRom.Core\Settings\SettingsService.cs) - Existing settings service

**Standards & Guidelines:**

- [ ] [BACKEND_ARCHITECTURE.md](https://github.com/MetalHexx/TeensyROM-Web/blob/main/src/docs/BACKEND_ARCHITECTURE.md) - Backend architecture overview
- [ ] [LaunchRandomTests.cs](C:\dev\src\TeensyROM-Web\src\apps\api\src\TeensyRom.Api.Tests.Integration\LaunchRandomTests.cs) - Integration test patterns
...
- [TeensySettings.cs](C:\dev\src\TeensyROM-Web\src\apps\api\src\TeensyRom.Core\Settings\TeensySettings.cs) - Domain model to mirror
- [LaunchRandomModels.cs](C:\dev\src\TeensyROM-Web\src\apps\api\src\TeensyRom.Api\Endpoints\Player\LaunchRandom\LaunchRandomModels.cs) - Example DTO patterns

**Implementation Subtasks:**

- [ ] **Create GetSettingsModels.cs**: Define `GetSettingsResponse` DTO with nested DTOs for all settings sections
  - `GetSettingsResponse` contains: `ConnectionSettingsDto`, `PlayerSettingsDto`, `FileTransferSettingsDto`, `SearchSettingsDto`, `AppSettingsDto`
...
- [ ] **Write Tests**: Tests will be in endpoint integration tests (no unit tests needed for DTOs)
...
**Related Documentation:**
- [LaunchRandomModels.cs](C:\dev\src\TeensyROM-Web\src\apps\api\src\TeensyRom.Api\Endpoints\Player\LaunchRandom\LaunchRandomModels.cs) - Example validator patterns
- [Domain Settings Models](C:\dev\src\TeensyROM-Web\src\apps\api\src\TeensyRom.Core\Settings) - Validation constraints
...
- [ ] **Write Tests**: Validation tests will be covered in integration tests
...
- [ ] **Write Tests**: Mapper behavior will be tested through endpoint integration tests
...
**Related Documentation:**
- [LaunchRandomEndpoint.cs](C:\dev\src\TeensyROM-Web\src\apps\api\src\TeensyRom.Api\Endpoints\Player\LaunchRandom\LaunchRandomEndpoint.cs) - Endpoint structure example
- [ISettingsService](C:\dev\src\TeensyROM-Web\src\apps\api\src\TeensyRom.Core\Settings\ISettingsService.cs) - Settings service interface
...
**Related Documentation:**
- [LaunchRandomEndpoint.cs](C:\dev\src\TeensyROM-Web\src\apps\api\src\TeensyRom.Api\Endpoints\Player\LaunchRandom\LaunchRandomEndpoint.cs) - Endpoint validation patterns
- [ISettingsService](C:\dev\src\TeensyROM-Web\src\apps\api\src\TeensyRom.Core\Settings\ISettingsService.cs) - Settings service interface
...
**Related Documentation:**
- [LaunchRandomTests.cs](C:\dev\src\TeensyROM-Web\src\apps\api\src\TeensyRom.Api.Tests.Integration\LaunchRandomTests.cs) - Test patterns and structure
- [EndpointFixture.cs](C:\dev\src\TeensyROM-Web\src\apps\api\src\TeensyRom.Api.Tests.Integration\Common\EndpointFixture.cs) - Test infrastructure
...
**Related Documentation:**
- [Program.cs](C:\dev\src\TeensyROM-Web\src\apps\api\src\TeensyRom.Tools.DeepSidExporter\Program.cs) - Startup configuration pattern
- [SettingsService](C:\dev\src\TeensyROM-Web\src\apps\api\src\TeensyRom.Core\Settings\SettingsService.cs) - Settings initialization
...
> Update this section during implementation with important findings, decisions, or gotchas.

---

## 🚧 Open Questions & Blockers

> Track unresolved questions or blockers here. Update as they are resolved.
...
**Task Completion:**
- [ ] Task 1: Create DTO Models (0/3 subtasks)
- [ ] Task 2: Create Validators (0/9 subtasks)
- [ ] Task 3: Create Mappers (0/3 subtasks)
- [ ] Task 4: GetSettings Endpoint (0/3 subtasks)
- [ ] Task 5: SaveSettings Endpoint (0/3 subtasks)
- [ ] Task 6: Integration Tests (0/16 subtasks)
- [ ] Task 7: Startup Settings Load (0/4 subtasks)
