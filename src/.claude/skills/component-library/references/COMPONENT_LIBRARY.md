...
📺 **See [COMPONENT_LIBRARY_CRT.md](../../crt-webgl-effects/references/COMPONENT_LIBRARY_CRT.md) for comprehensive CRT emulation documentation** (`crt-webgl-effects` skill).
