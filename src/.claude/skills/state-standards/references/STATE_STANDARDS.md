...
**Implementation**: See [`LOGGING_STANDARDS.md`](../../logging-standards/references/LOGGING_STANDARDS.md) (`logging-standards` skill) for complete logging standards including:
...
- **Logging Standards**: [`LOGGING_STANDARDS.md`](../../logging-standards/references/LOGGING_STANDARDS.md) - Emoji-enhanced logging patterns for operational visibility (`logging-standards` skill).
- **Testing Standards**: [`TESTING_STANDARDS.md`](../../testing-standards/references/TESTING_STANDARDS.md) - Unit, integration, and E2E testing patterns (`testing-standards` skill).
- **Nx Library Standards**: [`NX_LIBRARY_STANDARDS.md`](../../nx-library-standards/references/NX_LIBRARY_STANDARDS.md) - Library creation and integration patterns (`nx-library-standards` skill).
- **Style Guide**: [`STYLE_GUIDE.md`](../../style-guide/references/STYLE_GUIDE.md) - UI styling standards (`style-guide` skill).
