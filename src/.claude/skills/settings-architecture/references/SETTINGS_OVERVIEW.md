...
- [Backend Architecture](../../backend-architecture/references/BACKEND_ARCHITECTURE.md) - API layer patterns (`backend-architecture` skill)
- [State Standards](../../state-standards/references/STATE_STANDARDS.md) - NgRx Signal Store patterns (`state-standards` skill)
- [Testing Standards](../../testing-standards/references/TESTING_STANDARDS.md) - Testing settings components (`testing-standards` skill)
