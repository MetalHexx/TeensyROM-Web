 ...
 * runtimes, and `hydrate()` loads their MIDI/device bindings so a reload opens the page ready to
 * play. Bindings hydration is non-critical — a rejection logs a warning and the decks simply stay
