...
export function TransferJobDto2FromJSONTyped(json: any, ignoreDiscriminator: boolean): TransferJobDto2 {
    ...
    return {
        ...
        'expandingArchive': json['expandingArchive'] == null ? undefined : json['expandingArchive'],
        'expansionBytesWritten': json['expansionBytesWritten'],
        'expansionBytesDeclared': json['expansionBytesDeclared'],
        'expandedFileCount': json['expandedFileCount'] == null ? undefined : json['expandedFileCount'],
    };
}
