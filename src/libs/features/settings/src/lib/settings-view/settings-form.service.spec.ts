        ...
        knownDevices: [
          {
            ...
            videoSettings: { enableVideo: false, videoDeviceId: '' },
            audioSettings: { enableAudioStream: false, audioDeviceIndex: -1, audioDeviceName: '', captureChannelCount: 1, sampleRate: 48000, channels: [] },
          },
          {
            deviceId: 'device-beta',
            videoSettings: { enableVideo: true, videoDeviceId: 'vid-1' },
            audioSettings: { enableAudioStream: true, audioDeviceIndex: 2, audioDeviceName: 'Mic', captureChannelCount: 2, sampleRate: 44100, channels: [] },
          },
          {
