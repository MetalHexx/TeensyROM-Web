...
class Program
{
  static async Task Main(string[] args)
  {
    ...
    TcpObservablePort? tcpPort = new TcpObservablePort(new SimpleLoggingService());
    ...
    try
    {
      ...
      while (true)
      {
        ...
        //Thread.Sleep(2000);
        //ExecuteLaunchSidCommand(tcpPort, "/music/MUSICIANS/L/LukHash/Alpha.sid");
        //Thread.Sleep(2000);
        //ExecuteLaunchSidCommand(tcpPort, "/music/MUSICIANS/M/Manganoid/Le_Shagma.sid");
        //Thread.Sleep(2000);
  ...
  private static void TryReconnect(TcpObservablePort tcpPort)
  {
  ...
  static void ExecuteResetCommand(TcpObservablePort tcpPort)
  {    
  ...
  static void ExecutePingCommand(TcpObservablePort tcpPort, string description)
  {
  ...
  static bool ExecuteMinimalCheckCommand(TcpObservablePort tcpPort)
  {
  ...
  static void ExecuteGetFileCommand(TcpObservablePort tcpPort, string path)
  {
  ...
  static void ExecuteGetDirectoryRecursiveCommand(TcpObservablePort tcpPort, string path, bool recursive = false)
  {
  ...
  static void GetDirectoryRecursive(TcpObservablePort tcpPort, string path, List<(string name, long size, string path)> allFiles, List<string> allDirectories, ref int totalFiles, ref int totalDirectories, bool recursive)
  {
  ...
  static (List<(string name, long size)> files, List<string> directories) ReadDirectoryContent(TcpObservablePort tcpPort, string basePath)
  {
  ...
  static TeensyToken WaitForDirectoryStartToken(TcpObservablePort tcpPort)
  {
    tcpPort.WaitForSerialData(numBytes: 2, timeoutMs: 20000);
  ...
  static void ExecuteLaunchCommand(TcpObservablePort tcpPort, string sidPath)
  {
  ...
  static SidLaunchResult PollForSidTokens(TcpObservablePort tcpPort)
  {
  ...
  static TeensyToken HandleAckWithResult(TcpObservablePort tcpPort)
  {
    tcpPort.WaitForSerialData(numBytes: 2, timeoutMs: 20000);
    byte[] recBuf = new byte[2];
    tcpPort.Read(recBuf, 0, 2);
  ...
  static void ReconnectForNextCommand(TcpObservablePort tcpPort)
  {
  ...
  static void HandleAck(TcpObservablePort tcpPort)
  {
    tcpPort.WaitForSerialData(numBytes: 2, timeoutMs: 20000);
    byte[] recBuf = new byte[2];
    tcpPort.Read(recBuf, 0, 2);
