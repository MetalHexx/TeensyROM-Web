...
public class SettingsServiceTests : IDisposable
{
    ...
    public void Constructor_ShouldCreateDefaultSettings_WhenFileDoesNotExist()
    {
        ...
        // BUG: Intentionally broken assertion - should be NotBeEmpty
        settings.SearchSettings.BannedDirectories.Should().BeEmpty("This test is intentionally broken to validate the PR workflow");
